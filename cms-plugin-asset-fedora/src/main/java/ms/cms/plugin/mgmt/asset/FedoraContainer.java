 ...
 */
public class FedoraContainer extends FedoraResourceImpl implements FedoraObject, Container {
    private final static Node binaryType = NodeFactory.createLiteral("fedora:binary");
    private final Logger logger = LoggerFactory.getLogger(getClass());

    /**
     * Constructor for FedoraContainer
     *
     ...
     */
    public FedoraContainer(final FedoraRepository repository, final HttpHelper httpHelper, final String path) {
